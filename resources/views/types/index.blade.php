...
<ol class="breadcrumb">
  ...
  &nbsp;&nbsp;
  <li class="breadcrumb-tem"> <a href="{{ route('type.create')}}"> Cadastrar Tipo de processo</a></li>
</ol>

<div class="card" style="background: #232632">
  <div class="card-body  text-white">
    <h3>Tipos de Processo Cadastrados</h3>
  </div>
</div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="{{ route('type.show', $type->id)}}" class="btn btn-success btn-sm"> <i class="fas fa-eye"></i>
                </a>
