...
<ol class="breadcrumb">
  <li class="breadcrumb-item"> <a href="{{ route('process.index')}}">Dashboard </a></li>
  &nbsp;&nbsp;
  <i class="fas fa-arrow-right mt-2 text-blue"></i>
  &nbsp;&nbsp;
  <li class="breadcrumb-tem"> <a href="{{ route('process.index')}}"> Gestão de Processos</a></li>
</ol>

<div class="card text-white" style="background: #232632">
  <div class="card-body col-md-12">
    <h3>Cadastro de novo processo</h3>
  </div>
</div>
