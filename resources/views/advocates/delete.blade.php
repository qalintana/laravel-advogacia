    ...
    <div class="card card-blue">
      <div class="row">
        <div class="card-body">
          ...
          <form action="{{route('advocate.destroy', $advocate->id)}}" method="POST">
            <h2 class=" text-center">Tem certeza que deseja eliminar o advogado {{ $advocate->nome }}
            </h2>
            <hr>
            ...
            <div class="row justify-content-center flex-row">
              ...
              &nbsp;
              <a href="{{ route('advocate.index')}}" class="btn btn-primary btn-sm"> <i class="fas fa-not-equal"></i>
                Não </a>
              &nbsp;
              <a href="{{ route('advocate.show', $advocate->id)}}" class="btn btn-info btn-sm"> <i
                  class="fas details"></i>
                Ver detalhes </a>
            </div>
          </form>
