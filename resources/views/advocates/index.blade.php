...
<ol class="breadcrumb">
  ...
  &nbsp;&nbsp;
  <li class="breadcrumb-tem"> <a href="{{ route('advocate.create')}}"> Cadastrar Advogado</a></li>
</ol>
      ...
      <div class="card-header">
        ...
        <div class="row">
          <div class="col-md-8 text-left white">
            <a href="{{ route('advocate.create')}}" class="btn btn-primary"
        ...
        <table class="table table-hover text-nowrap">
          ...
          <tbody>
            ...
            <tr>
              <td></td>
              <td>{{$advocate->nome}}</td>
              <td>{{$advocate->cituis}}</td>
              <td>
                <a href="{{ route('advocate.edit', $advocate->id)}}" class="btn btn-primary btn-sm"> <i
                    class="fas fa-edit"></i> </a>
                <a href="{{ route('advocate.show', $advocate->id)}}" class="btn btn-success btn-sm"> <i
