  ...
  <div class="col-md-12" style="margin-top: -25px">
    <div class="card card-blue">
      <div class="row">
        <div class="card-body">
          {{-- form create avence --}}
          <form action="{{route('avence.destroy', $avence->id)}}" method="POST">
            <h2 class=" text-center">Tem certeza que deseja eliminar a avença {{ $avence->nome }}
            </h2>
            <hr>
            ...
            <div class="row justify-content-center flex-row">
              ...
              &nbsp;
              <a href="{{ route('avence.index')}}" class="btn btn-primary btn-sm"> <i class="fas fa-not-equal"></i>
                Não </a>
              &nbsp;
              <a href="{{ route('avence.show', $avence->id)}}" class="btn btn-info btn-sm"> <i class="fas details"></i>
                Ver detalhes </a>
            </div>
          </form>
