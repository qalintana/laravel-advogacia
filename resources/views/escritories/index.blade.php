...
<ol class="breadcrumb">
  ...
  &nbsp;&nbsp;
  <li class="breadcrumb-tem"> <a href="{{ route('escritory.create')}}"> Cadastrar Escritório</a></li>
</ol>
      ...
      <div class="card-header">
        ...
        <div class="row">
          <div class="col-md-8 text-left white">
            <a href="{{ route('escritory.create')}}" class="btn btn-primary"
      ...
      <div class=" card-body table-responsive p-0">
        <table class="table table-hover text-nowrap">
          ...
          <tbody>
            ...
            <tr>
              <td></td>
              <td>{{$escritory->nome}}</td>
              <td>
                <a href="{{ route('escritory.edit', $escritory->id)}}" class="btn btn-primary btn-sm"> <i
                    class="fas fa-edit"></i> </a>
                <a href="{{ route('escritory.show', $escritory->id)}}" class="btn btn-success btn-sm"> <i
